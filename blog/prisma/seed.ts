...
// Buras� explicit many to many ili�ki i�in kullan�l�yor. Ama buna gerek yok ��nk� prisma bunu otomatik olarak yap�yor. Yeni bir tablo olu�turmak mant�ks�z.
...
*/
async function main() {
  //XXX: �nce roller olu�mas� laz�m ki kullan�c�lar rolleri ile birlikte olu�sun.
  //XXX: Silerken de �nce kullan�c�lar� sil sonra rolleri sil.
