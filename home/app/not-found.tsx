        ...
        <div className="flex items-center justify-center w-4/5 h-[75%] max-lg:h-[60%] m-auto">
          <div className="overflow-hidden rounded-lg shadow shadow-slate-700 bg-slate-950/40">
            <div className="flex flex-col items-center justify-center h-max">
              <h1 className="font-bold leading-relaxed text-purple-500 text-9xl max-mobile-xl:text-8xl">404</h1>
              <h1 className="-mt-10 text-6xl text-center font-medium max-lg:text-5xl text-slate-500 max-md:text-4xl max-mobile-xl:text-2xl">oops! Page not found</h1>
              <p className="px-12 text-2xl font-medium text-slate-700 max-md:text-lg max-mobile-lg:px-5 max-mobile-xl:text-center">Oops! The page you are looking for does not exist. It might have been moved or deleted.</p>
