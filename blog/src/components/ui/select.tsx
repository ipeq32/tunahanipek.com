...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-7 w-full items-center justify-between rounded-md border border-black/60 bg-transparent px-3 py-2 text-sm placeholder:text-slate-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-slate-600 hover:dark:border-slate-400 dark:bg-slate-950 dark:placeholder:text-slate-400',
      className
    )}
    {...props}
  >
